...
#             db_name = cnf.get_val("DB", "db_name")
            with pyodbc.connect('DRIVER={ODBC Driver 17 for SQL Server};SERVER=EPUALVIW001F\SQLEXPRESS;PORT=1433;DATABASE=TRN;Trusted_Connection=yes;TDS_VERSION=8.0;') as conn:
                curs = conn.cursor()
